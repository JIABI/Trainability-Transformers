...
from models.conformer_act import conformer1d_small

from models.s4_act import s4d1d_small
...
def make_model(args, device):
    ...
    if args.model == "conformer":
        ...
        model = conformer1d_small(
            ...
            drop_path_rate=args.conf_drop_path,
        ...
        model = s4d1d_small(
            ...
            use_posenc=False, drop_path_rate=args.s4_drop_path,
...
def main():
    ...
    ap.add_argument("--act", type=str, choices=["gelu", "relu", "silu", "selu"], default="gelu")
    ...
    ap.add_argument("--save_dir", type=str, default="runs_act")
    ...
    save_dir = os.path.join(args.save_dir, args.model, args.act)
    ...
    print(f"Start training: model={args.model}, act={args.act}")
