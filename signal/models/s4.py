...
class S4DKernel(nn.Module):
    ...
    def forward(self, u: torch.Tensor) -> torch.Tensor:
        ...
        # remove the extra left-half produced by padding => conv1d with padding T-1 gives exact T
        # residual D*u
...
def s4d1d_small(num_classes: int = 5, in_chans: int = 1,
                ...
                global_pool: str = "mean") -> S4DClassifier1D:
...
def s4d1d_tiny(num_classes: int = 5, in_chans: int = 1) -> S4DClassifier1D:
