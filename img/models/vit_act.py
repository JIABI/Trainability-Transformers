...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4.0, qkv_bias=True,
                 ...
                 drop=0.0, attn_drop=0.0, drop_path=0.0, act_layer="gelu"):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            ...
            Block(embed_dim, num_heads, mlp_ratio, qkv_bias, drop_rate, attn_drop_rate, dpr[i], act_layer=act_layer)
...
def vit_b(patch_size = 16, img_size=224, num_classes=80, drop_path_rate=0.1, global_pool="cls", act_layer="gelu"):
...
def vit_b16(**kwargs): return vit_b(patch_size = 16, **kwargs)
def vit_b32(**kwargs): return vit_b(patch_size = 32, **kwargs)