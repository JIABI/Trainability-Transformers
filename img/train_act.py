...
from models.vit_act import vit_b  # must accept patch_size
from models.swin_act import swin_tiny, swin_tiny_nomerge
from models.cvt_act import cvt_13
from models.linformer_act import linformer_b16
...
def main():
    ...
    parser.add_argument("--act", type=str, default="gelu",
                        choices=["gelu", "relu", "silu", "selu"],
                        help="activation function for MLP in Swin/ViT/CvT")
    ...
    parser.add_argument("--save_dir", type=str, default="runs_act")
    ...
    # out dir: runs_act/<model>/<activation>/

    out_dir = os.path.join(args.save_dir, args.model, args.act)
